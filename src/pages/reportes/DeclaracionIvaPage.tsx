...
const snapshotToEdit = (d: DeclaracionIva): EditValues => {
  ...
  // Fallback para registros sin desglose guardado
  return {
...
export default function DeclaracionIvaPage() {
  ...
  // ─── Totales en vivo (se recalculan al editar) ────────────────────────────
  ...
  // InputNumber en modo edición; texto formateado en modo lectura
